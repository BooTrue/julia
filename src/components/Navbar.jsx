  ...
  return (
    <nav
      className={`${
        ...
        scrolled ? "bg-[#FCF6ED]" : "bg-transparent"
      }`}
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-[#7F6A97] text-[18px] font-bold cursor-pointer flex '>
            Груминг в Челябинске &nbsp;
            <span className='sm:block hidden'> | Стрижка собак и кошек</span>
          </p>
        </Link>
        ...
        <ul className='list-none hidden sm:flex flex-row gap-10'>
          {navLinks.map((nav) => (
            <li
              ...
              } hover:text-[#ef6c7c] text-[18px] font-medium cursor-pointer`}
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center w-[30px]'>
          {/* <img
